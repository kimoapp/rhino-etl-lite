...
namespace Rhino.Etl.Async
{
    ...
    public class EtlAsyncProcessBase<TDerived> : WithLoggingMixin 
        where TDerived : EtlAsyncProcessBase<TDerived>
    {
        /// <summary>
        ...
        /// </summary>
        private readonly List<IAsyncOperation> lastOperations = new List<IAsyncOperation>();

        /// <summary>
        /// Ordered list of the operations in this process
        /// </summary>
        protected readonly List<IAsyncOperation> operations = new List<IAsyncOperation>();
        ...
        public TDerived Register(IAsyncOperation operation)
        {
        ...
        /// </summary>
        /// <param name="operation">The operation.</param>
        public TDerived RegisterLast(IAsyncOperation operation)
        {
