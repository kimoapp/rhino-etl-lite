...
namespace Rhino.Etl.Async.Operations
{
    ...
    /// </summary>
    public abstract class OutputCommandAsyncOperation : AbstractCommandAsyncOperation
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutputCommandAsyncOperation"/> class.
        /// </summary>
        /// <param name="connectionStringName">Name of the connection string.</param>
        public OutputCommandAsyncOperation(string connectionStringName) : this(ConfigurationManager.ConnectionStrings[connectionStringName])
        {
        }
        ...
        public OutputCommandAsyncOperation(ConnectionStringSettings connectionStringSettings)
        ...
        public override async IAsyncEnumerable<Row> Execute(IAsyncEnumerable<Row> rows)
        {
            ...
            {
                await foreach (Row row in new SingleRowEventRaisingAsyncEnumerator(this, rows))
                {
