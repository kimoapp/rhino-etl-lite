...
namespace Rhino.Etl.Async.Operations
{
    ...
    /// </summary>
    public abstract class AbstractDatabaseAsyncOperation : AbstractAsyncOperation
    {
        ...
        protected AbstractDatabaseAsyncOperation(string connectionStringName)
        {
        ...
        protected AbstractDatabaseAsyncOperation(ConnectionStringSettings connectionStringSettings)
        {
